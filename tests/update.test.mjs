...
test("le service worker V17 active immédiatement la nouvelle version", () => {
  assert.match(serviceWorker, /APP_VERSION = "17\.0\.0"/);
  assert.match(serviceWorker, /CACHE_NAME = "cr3atix-adventure-v17"/);
